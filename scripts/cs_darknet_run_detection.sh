...
darknet="/home/cs/Documents/packages/darknet_fork"
data_cfg="/media/win/_/IJCB2017/cfg/ijcb2017-yolo-voc.data"
network_cfg="/media/win/_/IJCB2017/cfg/ijcb2017-yolo-voc-train.cfg"
...
for filename in $images/*.jpg; do
    ...
    echo "[  OK  ] Created $image_with_detections";
done
